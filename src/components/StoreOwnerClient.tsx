        ...
        <div>
          ...
          <div className={styles.panel} style={{marginTop:'0.75rem'}}>
            ...
            <div className={shippingMode === 'flat' ? styles.itemGridNoShip : styles.itemGrid}>
              ...
              <div><label>Qty</label><input type="number" value={iQty} onChange={e => setIQty(e.target.value)} min="1" max="500" /></div>
            </div>
            <div className="field">
        ...
        <div className={styles.editOverlay} onClick={() => setEditingDrop(null)}>
          <div className={styles.editBox} onClick={e => e.stopPropagation()}>
            ...
            <div className={styles.itemGrid}>
              ...
              <div><label>Qty</label><input type="number" value={eQty} onChange={e => setEQty(e.target.value)} min="1" max="500" /></div>
            </div>
            <div className="field">
